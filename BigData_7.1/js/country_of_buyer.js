...
var series = [];
[['中国', BJData],['日本', RBData],['意大利', YDLData],['罗马尼亚',LMNYData],['英国', YGData],['印度', YDData],['澳大利亚', ADData],['西班牙', XBYData],['马来西亚', MLData],['俄罗斯', ELSData],['美国', MGData],['巴西', BXData]].forEach(function (item, i) {
    series.push({
        name: '贸易' + ' Top15',
        type: 'lines',
        zlevel: 1,
...
//box1
    ...
    xAxis: [{
        ...
        data: ['马来西亚','印度','俄罗斯','以色列','斯里兰卡','也门','土耳其','希腊','叙利亚','波兰','新加坡','罗马尼亚'],
    }],
    yAxis: [
     {
    ...
    series: [ {
            ...
            type:'bar',
            barWidth:'15',
            data:[200, 490, 700, 232, 256, 767, 622, 640, 330,300,500,800],
             itemStyle: {
            normal: {
                color: '#e94f2e',
                width:0.5,
       ...
       },
    {
        ...
        data: [0.5,0.6,0.4,0.5,0.7,0.7,0.8,0.4,0.5,0.3,0.8,0.5]
    }, ]
	...
	function bigbox1() {
        ...
        data: ['马来西亚','印度','俄罗斯','以色列','斯里兰卡','也门','土耳其','希腊','叙利亚','波兰','新加坡','罗马尼亚'],
			...
			series: [{
				...
				y: 'center',
				barWidth: '15',
				data: [200, 490, 700, 232, 256, 767, 1356, 640, 330, 300, 500, 800],
				itemStyle: {
					normal: {
						color: '#e94f2e',
						width: 0.5,
