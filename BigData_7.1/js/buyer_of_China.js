...
var BJData = [
    [{name:'潍坊'}, {name:'长沙',value:95},{color:'#ed8b9a'}],
    [{name:'潍坊'}, {name:'上海',value:90},{color:'#ed8b9a'}],
    [{name:'潍坊'}, {name:'天津',value:80},{color:'#FF8C00'}],
    [{name:'潍坊'}, {name:'武汉',value:70},{color:'#f8d59e'}],
    [{name:'潍坊'}, {name:'成都',value:60},{color:'#FFFF00'}],
    [{name:'潍坊'}, {name:'广州',value:50},{color:'#FFFF00'}],
    [{name:'潍坊'}, {name:'杭州',value:40},{color:'#98FB98'}],
    [{name:'潍坊'}, {name:'南京',value:30},{color:'#7FFF00'}],
    [{name:'潍坊'}, {name:'沈阳',value:50},{color:'#7FFF00'}],
    [{name:'潍坊'}, {name:'长春',value:60},{color:'#7FFF00'}],
    [{name:'潍坊'}, {name:'贵阳',value:40},{color:'#7FFF00'}],
    [{name:'潍坊'}, {name:'西宁',value:50},{color:'#7FFF00'}]
];

var detailData = [
	{area:'长沙',aa:1000,bb:800},
	{area:'上海',aa:1000,bb:800},
	{area:'天津',aa:1000,bb:800},
	{area:'武汉',aa:1000,bb:800},
	{area:'成都',aa:1000,bb:800},
	{area:'广州',aa:1000,bb:800},
	{area:'杭州',aa:1000,bb:800},
	{area:'南京',aa:1000,bb:800},
	{area:'沈阳',aa:1000,bb:800},
	{area:'长春',aa:1000,bb:800},
	{area:'贵阳',aa:1000,bb:800},
	{area:'西宁',aa:1000,bb:800}
];
...
//          fontWeight: 'normal',
    ...
    xAxis: [{
		...
		data: ['湖南省','上海市','天津市','湖北省','四川省','广东省','浙江省','江苏省','辽宁省','吉林省','贵州省','青海省']
    ...
    series: [ {
            ...
            type:'bar',
            barWidth:'30%',
            data:[200, 490, 700, 232, 256, 767, 1356, 622, 326, 200, 640, 330],
             itemStyle: {
            normal: {
                color: '#e94f2e',
                width:0.5,
       ...
       },
    {
        ...
        data: [0.5,0.6,0.4,0.5,0.7,0.7,0.8,0.1,0.5,0.6,0.4,0.5]
    }, ]
