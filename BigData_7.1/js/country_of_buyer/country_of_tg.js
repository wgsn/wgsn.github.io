...
//box1
    ...
    xAxis: [{
        ...
        axisLabel:{  
          ...
          data: ['俄罗斯','美国','日本',{value:'泰国',textStyle:{color:'red'}},'韩国','中国台湾','香港','马来西亚','印度','澳大利亚'],
    }],
    yAxis: [
     {
...
//box3
    ...
    legend: {
        ...
        y : 'center',
        height:'100',
      data: ['机械', '建材', '化工', '纺织服装,鞋', '能源类', '家居装饰品', '日用消费品', '能源类2',],
        textStyle:{
            color:'white'
        },
    }, 
...
//box4
    ...
    xAxis: [{
        ...
        data: ['机械', '建材', '化工', '纺织服装,鞋', '能源类', '家居装饰品', '日用消费品', '能源类',],
    }],
    yAxis: [
     {
       ...
       },
    {
        ...
        data: [0.5, 0.6, 0.4, 0.5, 0.6, 0.5, 0.6, 0.5]
    }, ]
