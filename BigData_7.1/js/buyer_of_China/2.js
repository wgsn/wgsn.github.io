...
//                      		rotate:45,
                    ...
                    series: [
                         
                        {
                            ...
                            barWidth:'26%',
                            data:[851, 1396, 1744, 4687, 4436, 3866, 2954, 2812, 2786, 3455, 3057, 1754]
                        },
                        {
                            name:'同期环比曲线',
                            type:'line',
...
//                      		rotate:15,
                            ...
                            type: 'category',
                            data:['礼品','电子及家电','纺织服装、鞋','机械','家居装饰品','建材','日用消费品','办公箱包'],
                        }
                    ],
                    yAxis: [
                        {
                    ...
                    series: [
                        ...
                        },
                        {
                            ...
                            data:[0.49,0.5,0.6,0.56,0.5,0.55,0.6,0.48]
                        }
                    ]
           };
