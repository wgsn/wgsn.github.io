...
//                      		rotate:45,
                    ...
                    series: [
                         
                        {
                            ...
                            barWidth:'26%',
                            data:[389, 594, 985, 1896, 1736, 1544, 1631, 1235, 1589, 2109, 2251, 586]
                        },
                        {
                            name:'同期环比曲线',
                            type:'line',
		    ...
		    legend: {
		        ...
		        top:'20%',
		        orient:'vertical',
		        data:['机械','电子及家电','纺织服装、鞋','家居装饰品','办公箱包','化工','休闲用品','日用消费品'],
		        textStyle:{
		        	color:'#fff',
		        },
		        tooltip: {
...
//                      		rotate:15,
                    ...
                    series: [
                        ...
                        },
                        {
                            ...
                            yAxisIndex: 1,
                            data:[0.5,0.6,0.3,0.7,0.4,0.6,0.6,0.5]
                        }
                    ]
           };
