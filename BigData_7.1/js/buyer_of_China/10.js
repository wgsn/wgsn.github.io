...
//                      		rotate:45,
                    ...
                    series: [
                         
                        {
                            ...
                            barWidth:'26%',
                            data:[358, 561, 871, 1758, 1631, 1452, 1431, 1541, 1633, 2015, 2123, 679]
                        },
                        {
                            name:'同期环比曲线',
                            type:'line',
		    ...
		    legend: {
		        ...
		        top:'20%',
		        orient:'vertical',
		        data:['纺织服装、鞋','食品类产品','医药及医疗保险','机械','电子及家电','五金工具','礼品','日用消费品'],
		        textStyle:{
		        	color:'#fff',
		        },
		        tooltip: {
...
//									
		            ...
		            data:[
		                {value:85, name:'纺织服装、鞋'},
		                {value:90, name:'食品类产品'},
		                {value:85, name:'医药及医疗保健'},
		                {value:85, name:'机械'},
		                {value:80, name:'电子及家电'},
		                {value:88, name:'五金工具'},
		                {value:90, name:'礼品'},
...
//                      		rotate:15,
                    ...
                    series: [
                        ...
                        },
                        {
                            ...
                            yAxisIndex: 1,
                            data:[0.5,0.6,0.4,0.7,0.6,0.4,0.6,0.5]
                        }
                    ]
           };
