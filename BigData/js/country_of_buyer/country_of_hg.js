...
//  data:['采购量','同期环比曲线'],
    ...
    xAxis: [{
        ...
        data: ['俄罗斯','美国','日本','泰国',{value:'韩国',textStyle:{color:'red'}},'中国台湾','香港','马来西亚','印度','澳大利亚'],
    }],
    yAxis: [
     {
	...
	function bigbox4() {
		...
		option = {
			...
			series: [{
				...
				data: [0.5, 0.6, 0.5, 0.6, 0.3, 0.7, 0.6, 0.5]
			}, ]
