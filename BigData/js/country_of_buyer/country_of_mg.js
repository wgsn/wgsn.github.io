...
//  data:['采购量','同期环比曲线'],
    ...
    xAxis: [{
        ...
        data: ['俄罗斯',{value:'美国',textStyle:{color:'red'}},'日本','泰国','韩国','中国台湾','香港','马来西亚','印度','澳大利亚'],
    }],
    yAxis: [
     {
...
//box2
    ...
    series: [ {
            ...
            type:'bar',
            barWidth:'15',
            data:[11, 9,10, 11, 10,11, 11, 13,0,0,0,0],
             itemStyle: {
            normal: {
                color: '#e94f2e',
                width:0.5,
       ...
       },
    {
        ...
        data: [0.4,0.5,0.7,0.4,0.3,0.5,0.3,0.7,0,0,0,0]
    }, ]
