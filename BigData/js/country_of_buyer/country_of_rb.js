...
//  data:['采购量','同期环比曲线'],
    ...
    xAxis: [{
        ...
        axisLabel:{  
          ...
          data: ['俄罗斯','美国',{value:'日本',textStyle:{color:'red'}},'泰国','韩国','中国台湾','香港','马来西亚','印度','澳大利亚'],
    }],
    yAxis: [
     {
...
//box2
    ...
    series: [ {
            ...
            type:'bar',
            barWidth:'15',
            data:[10, 11,12, 13, 10, 9, 10, 11, 14, 11, 10, 9],
             itemStyle: {
            normal: {
                color: '#e94f2e',
                width:0.5,
       ...
       },
    {
        ...
        data: [0.3,0.6,0.5,0.6,0.4,0.5,0.4,0.7,0.6,0.5,0.4,0.6]
    }, ]
...
//box3
    ...
    legend: {
        ...
        y : 'center',
        height:'100',
      data: [ '机械', '家居装饰品', '建材', '日用消费品', '休闲用品','其他'],
        textStyle:{
            color:'white'
        },
    }, 
	...
	function bigbox4() {
		...
		option = {
			...
			series: [{
				...
				data: [0.6, 0.5, 0.3, 0.7, 0.4, 0.5, 0.3, 0.5]
			}, ]
