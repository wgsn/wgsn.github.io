...
//                      		rotate:45,
                    ...
                    series: [
                         
                        {
                            ...
                            barWidth:'26%',
                            data:[587, 794, 1563, 3005, 3125, 2586, 2133, 1236, 0,0,0,0]
                        },
                        {
                            name:'同期环比曲线',
                            type:'line',
		    ...
		    legend: {
		        ...
		        top:'20%',
		        orient:'vertical',
		        data:['机械','家居装饰品','日用消费品','建材','电子及家电','其他'],
		        textStyle:{
		        	color:'#fff',
		        },
		        tooltip: {
